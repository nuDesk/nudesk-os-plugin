...
- Milestone and outcome focused — what moved strategically, what was decided, what shipped
...
- Each bullet should stand alone as meaningful to a co-founder reading it
- 2-4 bullets per section maximum — if you need more, you are too detailed
...
**Do include:**
- Major milestones reached or missed
- Strategic decisions made and why
- Key client interactions and outcomes
- Risks or flags that need executive attention
- High-level next priorities

**Do not include:**
- Specific tool or platform names (e.g., TalentLMS, specific API names) unless they are the strategic point
- Names of individual meeting participants or session titles
- Tactical sub-steps within a larger initiative (e.g., "pre-planning call scheduled with Bryan and Ranjeev" — this is inside baseball)
- Operational tasks that are routine and expected (invoicing cycles, admin items)
- Recruiting pipeline details unless there is a significant hiring decision
- Any detail that would only matter to someone doing the work, not someone reviewing the outcome
...
- Written for a co-founder audience — what does Sean need to know, not what did you do today
- Candid about misses — name them with rationale, not just omit them
- Outcome-focused — what moved, what was decided, what changed
- Forward-looking — each initiative ends with the single most important next milestone
