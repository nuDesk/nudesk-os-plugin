...
| **Playwright** | browser_take_screenshot | UI screenshots for design review and debugging |
...
|---------|-----------|-----------|-----------|-----------|
| **Global** | Full Asana, Fireflies, HubSpot, GWS, Drive, Gamma, Context7, Playwright (screenshot) | `Bash(*)` | Force push, hard reset, rm -rf, clean, branch -D | Controlled |
